...
const Settings = () => {
  ...
  return (
    <div className="settings-page page-shell animate-fade-in">
      <PageHeader
        eyebrow="Workspace settings"
        title="Settings"
        description="Manage garage identity, account details, and access credentials from a polished control panel."
      />
      ...
      <div className="settings-grid">
        ...
        <Card>
          ...
          <CardContent className="form-stack">
            ...
            <Button className="w-full mt-4" onClick={() => setIsPasswordModalOpen(true)}>
              Change Password
            </Button>
          </CardContent>
        </Card>
